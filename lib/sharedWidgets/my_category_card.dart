...
class MyCategoryCard extends StatefulWidget {
  ...
  MyCategoryCard({Key? key,this.icon,this.text,this.index,this.returnIndex,this.isSelected}) : super(key: key);
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: widget.isSelected == true
                ? Border.all(color: AppColors.blueText.withOpacity(0.5), width: 1)
                : null,
            boxShadow: [
              BoxShadow(
